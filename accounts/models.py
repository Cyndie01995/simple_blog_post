...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, email, password, **extra_fields): # for creating super user for admin to access the admin dashboard
...
# to use django default user models  
